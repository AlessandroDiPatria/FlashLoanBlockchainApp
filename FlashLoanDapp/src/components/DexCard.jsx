...
function DexCard() {
  ...
  const spenderAddress = '0xb39f2AbCa086Cdc4dC1a82DF4f3Dc6194e1aC3B7'; // address of the spender
  const contractAddress = "0xb39f2AbCa086Cdc4dC1a82DF4f3Dc6194e1aC3B7";
  ...
  async function DepositLiquidity() {
    ...
    async function ApproveTokens() {
      const tokenContract = new web3.eth.Contract(ERC20TokenABI, token);
  ...
  const handleChangeB = (event) => {
    ...
    //const value = findPrice(token,tokenObject,contractAddress)
    //setPrice(value)
